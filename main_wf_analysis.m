...
cfg = struct('troughalign',1,'interpn',10,'interptype','spline','normalize',1,'fsample',40000);
...
[dip1,pdip1,xl1,xu1,ind_nar1,ind_bro1,ind_fuz1,aic1_1,aic1_2,bic1_1,bic1_2] = waveformSeparation(X1,'peak2trough','Peak to trough duration',Xlim,mu,sigma,pcomponents);
...
pcomponents = [.3;.7];
Xlim = [0.03 0.5];
[dip3,pdip3,xl3,xu3,ind_nar3,ind_bro3,ind_fuz3,aic3_1,aic3_2,bic3_1,bic3_2] = waveformSeparation(X3,'25percRepol','Time for repolarization',Xlim,mu,sigma,pcomponents);
